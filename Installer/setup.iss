...
Root: HKLM; Subkey: "Software\EBOS\Toolbox"; ValueType: string; ValueName: "Channel"; ValueData: "{#AppChannel}"
Root: HKLM; Subkey: "Software\EBOS\Toolbox"; ValueType: string; ValueName: "Version"; ValueData: "{#MyAppVersion}"
...
Filename: {sys}\taskkill.exe; Parameters: "/f /im EBToolbox.exe"; Flags: skipifdoesntexist runhidden
