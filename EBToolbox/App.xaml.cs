...
namespace EBToolbox
{
    public partial class App : Application
    {
        ...
        private static Mutex _mutex = new(true, "{EBToolbox}");
...
#endif
            Version = RegistryHelper.GetValue($@"HKLM\SOFTWARE\EBOS\Toolbox", "Channel") + " v" + RegistryHelper.GetValue($@"HKLM\SOFTWARE\EBOS\Toolbox", "Version");
