...
using EBToolbox.Models.ProfileModels;
using Newtonsoft.Json;

namespace EBToolbox.HostBuilder
{
    public static class AddViewModelsHostBuilderExtensions
    {
        ...
        private static IHostBuilder AddProfiles(this IHostBuilder host)
        {
            ...
            DirectoryInfo profilesDirectory = new DirectoryInfo($"{Environment.GetEnvironmentVariable("windir")}\\EBModules\\Toolbox\\Profiles");
            try
            {
            ...
            {
                Directory.CreateDirectory($"{Environment.GetEnvironmentVariable("windir")}\\EBModules\\Toolbox\\Profiles");
            }
            finally
            {
                FileInfo[] profileFile = profilesDirectory.GetFiles();
        ...
        private static IHostBuilder AddLinksItemViewModels(this IHostBuilder host)
        {
            Dictionary<string, Links> configurationDictionary = new()
            {
                ...
                ["AdvancedConfigMustRead"] = new(@"https://docs.ebos.net/getting-started/post-installation/eb-folder/advanced-configuration/", App.GetValueFromItemList("AdvancedConfigMustRead"), ConfigurationType.Advanced),
                ["NvidiaDisplayContainerMustReadFirst"] = new(@"https://docs.ebos.net/getting-started/post-installation/eb-folder/advanced-configuration/#nvidia-display-container", App.GetValueFromItemList("NvidiaDisplayContainerMustReadFirst"), ConfigurationType.NvidiaDisplayContainerSubMenu),
                ["SecurityDocumentation"] = new(@"https://docs.ebos.net/getting-started/post-installation/eb-folder/security/", App.GetValueFromItemList("SecurityDocumentation"), ConfigurationType.Security),

                ["WindowsSettingsDocumentation"] = new(@"https://docs.ebos.net/getting-started/post-installation/eb-folder/windows-settings/", App.GetValueFromItemList("WindowsSettingsDocumentation"), ConfigurationType.Windows),
                ...
                ["ResetPC"] = new(@"https://docs.ebos.net/getting-started/reverting-eb/", App.GetValueFromItemList("ResetPC"), ConfigurationType.Troubleshooting),
                ["TroubleshootingDocumentation"] = new(@"https://docs.ebos.net/getting-started/post-installation/eb-folder/troubleshooting/", App.GetValueFromItemList("TroubleshootingDocumenation"), ConfigurationType.Troubleshooting),
            };
        ...
        private static IHostBuilder AddConfigurationButtonItemViewModels(this IHostBuilder host)
        {
            ...
            Dictionary<string, ConfigurationButton> configurationDictionary = new()
            {
                ...
                ["EBDefault"] = new(buttonCommand = new NetworkEBDefaults(), App.GetValueFromItemList("ResetFTH"), App.GetValueFromItemList("EBDefault"), ConfigurationType.TroubleshootingNetwork, "\uE839"),
