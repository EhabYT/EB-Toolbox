...
namespace EBToolbox.Services.ConfigurationServices
{
    ...
    {
        private const string EB_STORE_KEY_NAME = @"HKLM\SOFTWARE\EBOS\Services\PhoneLink";
        ...
        public void Disable()
        {
            ...
            RegistryHelper.SetValue(EB_STORE_KEY_NAME, "path", @$"{Environment.GetEnvironmentVariable("windir")}\EBDesktop\3. General Configuration\Mobile Devices (Phone Link)\Disable Mobile Device Settings (default).cmd");

            CommandPromptHelper.RunCommand(@"call %windir%\EBModules\Scripts\settingsPages.cmd /hide mobile-devices");
        ...
        public void Enable()
        {
            ...
            RegistryHelper.SetValue(EB_STORE_KEY_NAME, "path", @$"{Environment.GetEnvironmentVariable("windir")}\EBDesktop\3. General Configuration\Mobile Devices (Phone Link)\Enable Mobile Device Settings.cmd");

            CommandPromptHelper.RunCommand(@"call %windir%\EBModules\Scripts\settingsPages.cmd /unhide mobile-devices");
