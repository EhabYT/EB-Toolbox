...
namespace EBToolbox.Services.ConfigurationServices
{
    ...
    {
        private const string EB_STORE_KEY_NAME = @"HKLM\SOFTWARE\EBOS\Services\AppStoreArchiving";
        ...
        public void Disable()
        {
            ...
            RegistryHelper.SetValue(EB_STORE_KEY_NAME, "path", @$"{Environment.GetEnvironmentVariable("windir")}\EBDesktop\3. General Configuration\Store App Archiving\Disable Store App Archiving (default).cmd");
        ...
        public void Enable()
        {
            ...
            RegistryHelper.SetValue(EB_STORE_KEY_NAME, "path", @$"{Environment.GetEnvironmentVariable("windir")}\EBDesktop\3. General Configuration\Store App Archiving\Enable Store App Archiving.cmd");
