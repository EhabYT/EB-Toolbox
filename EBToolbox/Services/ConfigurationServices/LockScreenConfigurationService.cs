...
namespace EBToolbox.Services.ConfigurationServices
{
    ...
    {
        private const string EB_STORE_KEY_NAME = @"HKLM\SOFTWARE\EBOS\Services\LockScreen";
        ...
        public void Disable()
        {
            ...
            RegistryHelper.SetValue(EB_STORE_KEY_NAME, "path", @$"{Environment.GetEnvironmentVariable("windir")}\EBDesktop\4. Interface Tweaks\Lock Screen\Hide Lock Screen.cmd");
        ...
        public void Enable()
        {
            ...
            RegistryHelper.SetValue(EB_STORE_KEY_NAME, "path", @$"{Environment.GetEnvironmentVariable("windir")}\EBDesktop\4. Interface Tweaks\Lock Screen\Show Lock Screen (default).cmd");
