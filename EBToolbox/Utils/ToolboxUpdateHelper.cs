    ...
    public class ToolboxUpdateHelper
    {
        ...
        public static bool CheckUpdates()
        {
            try
            {
                ...
                int currentVersion = int.Parse(RegistryHelper.GetValue($@"HKLM\SOFTWARE\EBOS\Toolbox", "Version").ToString().Replace(".", ""));
        ...
        public static void InstallUpdate()
        {
            ...
            string downloadUrl = DOWNLOAD_URL + version + "/EBToolbox-Setup.exe";
